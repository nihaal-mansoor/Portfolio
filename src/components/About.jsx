    ...
    <section id="about" className="about">
        <div className="container">
            ...
            <p className="font-clash text-sm font-clash-light">With over four years of hands-on experience in front-end web development, I specialize in creating
                ...
                clean, maintainable code and attention to detail.

                <br /><br />Currently, I am expanding my expertise by delving into <span className="font-clash-medium accent-100">React</span> and
                modern JavaScript frameworks, ensuring that I remain at the cutting edge of front-end technology. My
                passion for user-centered design drives me to continuously explore and adopt new tools and
                methodologies, enabling me to deliver innovative solutions that elevate both user experience and
                business outcomes.
            </p>
        </div>
    </section>
