  ...
  return (
    <section id="hero" className="hero">
      <div className="container">
          ...
          <Copy delay={0.5}><h1 className="text-6xl font-clash font-clash-extralight split-text">Hi, I am Nihaal <br/><span className="text-6xl font-playfair font-clash-regular accent-100">Front-End Developer</span><br/> Focused on Creating Seamless Digital Experiences</h1></Copy>
