	...
	return (
		<header>
			<nav className="navbar border-bottom">
				...
				<div className="nav-toggle" onClick={toggleNav} id="navToggle">
					&#9776;
				</div>
				<ul
					className={`nav-links d-flex ${isActive ? "active" : ""}`}
					id="navLinks"
				>
					<li className="text-sm font-clash-regular">
						<a onClick={() => scrollToSection("about")}>About</a>
					</li>
					<li className="text-sm font-clash-regular">
						<a onClick={() => scrollToSection("what-i-do")}>Services</a>
					</li>
					<li className="text-sm font-clash-regular">
						<a onClick={() => scrollToSection("work")}>Work</a>
					</li>
					<li className="text-sm font-clash-regular">
						<a onClick={() => scrollToSection("tech")}>Blog</a>
					</li>
					<li className="text-sm font-clash-regular hire-button">
						<a onClick={() => scrollToSection("contact")}>Hire Me</a>
					</li>
				</ul>
			</nav>
		</header>
